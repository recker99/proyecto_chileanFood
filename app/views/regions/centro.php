...
<main class="container">
    <section class="region-header">
        <h1>🍴 Zona Central de Chile</h1>
        <p class="region-description">Disfruta de la gastronomía tradicional y moderna del centro del país</p>
    </section>
    ...
    <!-- Restaurantes de la zona central -->
    <section class="restaurants-section">
        <h2>Restaurantes de la Zona Central</h2>
                ...
                <?php foreach ($restaurants as $restaurant): ?>
                    <div class="restaurant-card">
                        ...
                        <div class="restaurant-info">
                            ...
                            <p class="restaurant-description"><?= htmlspecialchars($restaurant['restaurant_description'] ?? 'Restaurante tradicional de la zona central') ?></p>
        ...
        <?php else: ?>
            <div class="no-results">
                ...
                <p>Estamos trabajando para agregar más opciones gastronómicas en la zona central.</p>
            </div>
        <?php endif; ?>
    </section>
</main>
